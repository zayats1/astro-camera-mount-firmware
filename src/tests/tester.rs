    ...
    T: Write,
{
    ...
    fn parse_servo_test(&mut self) {
        ...
        writeln!(&mut self.tx, "parse_servo_test: PASSED").unwrap();
    }
    ...
    fn parse_stepper_test(&mut self) {
        ...
        writeln!(&mut self.tx, "parse_stepper_test: PASSED").unwrap();
    }
    ...
    fn parse_value_error_test(&mut self) {
        ...
        writeln!(&mut self.tx, "parse_value_error_tes: PASSED").unwrap();
    }
    ...
    fn parse_not_a_comand_error_test(&mut self) {
        ...
        writeln!(&mut self.tx, "parse_not_a_comand_error_test: PASSED").unwrap();
    }
    ...
    fn parse_sepparator_error_test(&mut self) {
        ...
        writeln!(&mut self.tx, "parse_sepparator_error_test: PASSED").unwrap();
    }
